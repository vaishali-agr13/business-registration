              ...
              <div class="d-flex flex-column gap-6">
                ...
                <div class="d-flex flex-column gap-3">
                  <ul class="header-menu list-unstyled mb-0 d-flex flex-column gap-2">
                    ...
                    <li class="header-item">
                      <a href="/contact" aria-current="true"
          ...
          <div class="row align-items-center">
            <div class="col-xl-4">
              <div class="d-flex align-items-center gap-4" data-aos="fade-up" data-aos-delay="100"
                ...
                <p class="mb-0 text-white fs-5 text-opacity-70">Get in touch <span class="text-primary">with our team to discuss</span> your project and discover the right digital solutions for your business growth.</p>
              </div>
            </div>
          </div>
