          ...
          <div class="row align-items-center">
            <div class="col-xl-4">
              <div class="d-flex align-items-center gap-4" data-aos="fade-up" data-aos-delay="100"
                ...
                <p class="mb-0 text-white fs-5 text-opacity-70">Discover the latest insights<span class="text-primary"> trends, and expert tips</span> in digital marketing, branding, and business growth.</p>
              </div>
            </div>
          </div>
          ...
          <!-- <div class="col-lg-6 mb-7">
            <div class="resources d-flex flex-column gap-6" data-aos="fade-up" data-aos-delay="200"
              ...
              <div class="resources-details">
                ...
                <h4 class="mb-0">10 SEO Strategies to Boost Your Website Traffic</h4>
              </div>
            </div>
          </div>
          <div class="col-lg-6 mb-7">
            <div class="resources d-flex flex-column gap-6" data-aos="fade-up" data-aos-delay="300"
              ...
              <div class="resources-details">
                <p class="mb-0">Dec 24, 2026</p>
                <h4 class="mb-0">How Social Media Drives Business Growth</h4>
              </div>
            </div>
          </div>
          <div class="col-lg-6 mb-7">
